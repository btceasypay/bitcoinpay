...
// Params defines a bitcoinpay network by its parameters.  These parameters may be
// used by bitcoinpay applications to differentiate networks as well as addresses
