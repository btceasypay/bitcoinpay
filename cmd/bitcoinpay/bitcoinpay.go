...
import (
	...
	_ "github.com/btceasypay/bitcoinpay/database/ffldb"
	"github.com/btceasypay/bitcoinpay/log"
	"github.com/btceasypay/bitcoinpay/node"
	...
	"github.com/btceasypay/bitcoinpay/version"
	"os"
	"runtime"
	"runtime/debug"
)
...
func main() {
	...
	if err := bitcoinpayMain(nil); err != nil {
		os.Exit(1)
	}
}

// bitcoinpayMain is the real main function for bitcoinpay.  It is necessary to work around
...
func bitcoinpayMain(nodeChan chan<- *node.Node) error {
	...
	log.Info("System info", "Bitcoinpay Version", version.String(), "Go version", runtime.Version())
