...
var (
	defaultHomeDir = util.AppDataDir("bitcoinpay", false)
...
type Config struct {
	...
	UseGoOutput   bool   `short:"g" long:"gooutput" description:"Display the candidates using Go syntax that is ready to insert into the bitcoinpay checkpoint list"`
...
func LoadConfig() (*Config, []string, error) {
	...
	// Update the home directory for bitcoinpay if specified. Since the home
