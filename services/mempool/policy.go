...
const (
	...
	// transactions.  This value is in Atom Bitcoinpay/kB. The default value is
	// 10000 Atoms/kB (aka. 0.0001 Bitcoinpay/kB)
	...
	// Bitcoinpay/kB (aka. 10000 Atom Bitcoinpay/kB), this results in a maximum allowed
	// high fee of 1 Bitcoinpay/kB.
...
type Policy struct {
	...
	// MinRelayTxFee defines the minimum transaction fee in AtomBitcoinpay/kB
