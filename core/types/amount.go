...
//
// NewAmount is for specifically for converting bitcoinpay to Atoms (atomic units).
...
// useful for services that build on top of bitcoinpay (for example, calculating
